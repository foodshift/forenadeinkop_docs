...
Förenade Inköp är ett projekt som vuxit ur myllan Food Shift, ett öppet nätverk och en plattform för aktörer som jobbar bortom hållbarhet. Organisationer, företag, forskare och privatpersoner som inte stannar vid det cirkulära eller det hållbara utan fokuserar på att också återskapa, återuppbygga, regenerera det som förstörts, det som gått förlorat. I det utrymmet vill vi verka på många plan:

![Food Shift](../public/img/svampskog.png)
