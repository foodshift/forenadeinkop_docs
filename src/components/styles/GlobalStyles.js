...
font-display:auto;font-style:normal;font-weight:400;
  ...
  * {
  ...
  html,
  body {
    font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'atten-round-new', 'atten-round-new Light', 'Oxygen',
  ...
  .navBarUL li a:visited {
    text-decoration: none;
  }
  .navBarUL li a:hover {
    text-decoration: underline solid #22904e;
  }
  .navBarUL li a:active {
    text-decoration: underline solid #22904e;
 }
  .navBarNav {
    border-left: 1px solid #435149;
    display: flex;
    align-items: center;
  }
  .navBarUL li a img,
  ...
  .showFrontLine .item .active > a {
    ...
    border-style: solid none solid solid;
    border-width: 1px 0px 1px 1px;
    background-color: #32a05f !important;
    color: #fff;
  }
